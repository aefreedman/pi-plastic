...
export const PLASTIC_SEARCH_CATALOG: readonly PlasticSearchCatalogEntry[] = [
  ...
  { name: "plastic_branchCreate", aliases: ["create branch", "new branch"], tags: ["branch", "mutation", "workflow"], guidance: ["Confirm the branch name and source before creating a branch."] },
