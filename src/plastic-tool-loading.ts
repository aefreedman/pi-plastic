...
export const PLASTIC_SEARCH_CATALOG: readonly PlasticSearchCatalogEntry[] = [
  ...
  { name: "plastic_branchCreate", aliases: ["create branch", "new branch"], tags: ["branch", "mutation", "workflow"], guidance: ["Create normal work branches beneath the current branch. Pass a leaf name for safe expansion; use allowNonDescendant only for intentional root/sibling branches."] },
